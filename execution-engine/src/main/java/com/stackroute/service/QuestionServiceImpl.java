...
public class QuestionServiceImpl implements QuestionService {
    ...
    public String finderror(String userName) throws Exception
    {
        ...
        String m="";
        String fileName="./src/"+userName+"/compile.log";   //make the changes
    ...
    public  String  run(String code)  {
        ...
        try{
            FileWriter fw=new FileWriter("./src/"+username+"/src/main/java/com/stackroute/*.java");
            fw.flush();
...
//            File file1=new File("./src/main/java/com/stackroute/*.java");
//            if(file1.delete()){
