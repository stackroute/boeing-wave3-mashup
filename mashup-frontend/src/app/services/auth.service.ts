...
export class AuthService {
  ...
  private loginUrl = 'http://localhost:8092/authentication-service/api/auth/signin';
  private signupUrl = 'http://localhost:8092/authentication-service/api/auth/signup';
